      ...
      <div className="root-container">
        ...
        <div className="section">
          <h2 className="h2-bold text-dark-600" style={{ fontSize: '32px', marginTop: '40px' }}>What is Juno?</h2>
            ...
            Juno allows you to interact with tailor made AI directly within your webbrowser.
            </p>
        </div>                 
        ...
        <div className="section">
          ...
          <p className="p-20-regular text-dark-400" style={{ fontSize: '18px', marginTop: '20px', lineHeight: '1.6', marginLeft: '3px'  }}>
            Discover a vast collection of ready-to-use AI components in Juno&apos;s <Link href="/library" className="text-primary-600 underline">Library</Link>, where you&apos;ll find pre-made AI profiles, prompts, voices, language models, and extensions ready for use.
          </p>
        </div>
        <Separator className="my-8" />
        ...
        <div className="section">
          <h2 className="h2-bold text-dark-600" style={{ fontSize: '32px', marginTop: '40px' }}>Seamlessly Interact</h2>
            <p className="p-20-regular text-dark-400" style={{ fontSize: '18px', marginTop: '20px', lineHeight: '1.6', marginLeft: '3px'  }}>
              Use the Juno Chrome Extension to seamlessly interact with your personalized AI, using a simple keybind.
            </p>
        </div>
      </div>
    </>
